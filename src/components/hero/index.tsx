  ...
  return (
    ...
    >
      <Image
        ...
        className="bg-image absolute top-[130px] left-1/2 w-full max-w-[1440px] -translate-x-1/2 opacity-0 md:top-22 lg:top-16 xl:top-2"
        priority
      />
      <Container className="flex flex-col items-center">
        <h1 className="font-inter-tight relative z-10 mt-[162px] text-center text-[38px] leading-[1] text-white md:text-[76px] lg:text-[100px] xl:text-[140px] xl:leading-[118px]">
